 ...
 *
 * $Header: /usr/build/VCS/pgf-vile/RCS/map.c,v 1.38 1994/12/04 14:44:48 pgf Exp $
 * 
 */
    ...
    char *bname;
{
	...
	if (show_all)
		mp = map_syskey;
	return liststuff(bname, FALSE, makemaplist, show_all, (void *)mp);
}
