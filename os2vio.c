 ...
 * stuff went in there.)
 *
 * $Header: /usr/build/VCS/pgf-vile/RCS/os2vio.c,v 1.1 1995/04/25 02:30:28 pgf Exp $
 */
...
extern  void	vio_move   P((int,int));
extern  void	vio_eeol   P((void));
extern  void	vio_eeop   P((void));
extern  void	vio_beep   P((void));
extern  void    vio_open   P((void));
extern	void	vio_rev    P((int));
extern	int		vio_cres   P((char *));
extern	void	vio_close  P((void));
extern	void	vio_putc   P((int));
extern	void	vio_kopen  P((void));
extern	void	vio_kclose P((void));
extern	void	vio_flush  P((void));
extern	void	vio_fcol   P((int));
extern	void	vio_bcol   P((int));
#if	SCROLLCODE
extern	void	vio_scroll P((int,int,int));
#endif
...
vio_eeop()
{
	...
	(void) VioWrtNCell(blank_cell(), MaxRows * MaxColumns, 
...
int
vio_cres(res)	/* change screen resolution */
